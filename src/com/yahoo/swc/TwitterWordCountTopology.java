...
public class TwitterWordCountTopology {
	...
	private static final String FED_MODE_ERROR_MSG = "TwitterWordCountTopology is in "
	...
	public static void main(String[] args) throws AlreadyAliveException, InvalidTopologyException {
		...
		builder.setSpout(twitterSampleSpoutId, new TwitterSampleSpout(),
				twitterSampleSpoutParallelism);

		// use SplitTweet Bolt
		String splitTweetBoltId = "split_tweet";
		int splitTweetParallelism = 10;
		builder.setBolt(splitTweetBoltId, new SplitTweet(), splitTweetParallelism).shuffleGrouping(
				twitterSampleSpoutId);
		...
		builder.setBolt(countWordBoltId, countWordBolt, countWordBoltParallelism).fieldsGrouping(
				splitTweetBoltId, new Fields("word"));

		// use PrinterCount Bolt to print the result
		String printerBoltId = "printer_bolt";
		int printerBoltPar = 10;
		builder.setBolt(printerBoltId, new PrintCount(), printerBoltPar).fieldsGrouping(
				countWordBoltId, new Fields("word"));
